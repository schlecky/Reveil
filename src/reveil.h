...
#define BL_DURATION 10

#define DELAI_SNOOZE 300
#define MAX_SNOOZE 20
...
const char* strMusiques[] = {"McGyver  ", "P Martini", "Bells    ","Deutschl.", "Traviata ", "Ind.Jones"};
const unsigned char *musiques[NBMUSIQUES] = {&macgyver[0],&pink_martini[0],&bells[0], &deutschland[0], &traviata[0], &indiana[0]};
